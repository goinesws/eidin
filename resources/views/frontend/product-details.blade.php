                    ...
                    <div class="col-lg-6 col-md-12 col-12">
                        <div class="product-images">
                            <main id="gallery">
                                ...
                                <div class="images">
                                    <img src="frontend/images/product-details/01.jpg" class="img" alt="#">
                                    <img src="frontend/images/product-details/02.jpg" class="img" alt="#">
                                    <img src="frontend/images/product-details/03.jpg" class="img" alt="#">
                                    <img src="frontend/images/product-details/04.jpg" class="img" alt="#">
                                    <img src="frontend/images/product-details/05.jpg" class="img" alt="#">
                                </div>
                            </main>
                        </div>
                    </div>
