                ...
                <div class="m-auto p-5 border shadow" style="width: 50%; border-radius:20px; background-color: #ffffff;">
                    ...
                    <div class="d-flex flex-row mb-5 me-4">
                        <h4 class="pt-1">
                            ...
                            @lang('addTagGenre.add_tag')
                        </h4> <br>
                    </div>
                    <form action="/admin/add-tag/add" method="POST">
                        @csrf
                        <div class="mb-5">
                            <label for="newTagName" class="form-label"> @lang('addTagGenre.tag_name')</label>
                        ...
                        @endif
                        <button type="submit" class="btn btn-primary" style="width: 100%">@lang('addTagGenre.add_tag')</button>
                    </form>
                </div>
            </div>
        </div>
